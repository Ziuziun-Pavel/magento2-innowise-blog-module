...
namespace Innowise\Blog\Ui\Component\Listing\Column;
...
{
    private const URL_PATH_EDIT = 'innowise_blog/post/edit';
    private const URL_PATH_DELETE = 'innowise_blog/post/delete';
